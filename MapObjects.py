...
logm = logging.getLogger("mapobjects")
#__all__ = ["mapobjects"]
...
class marker:
    ...
    def __str__(self):
        output_string = str(self.features_lst)
...
class polygon:
    def __init__(self):
        logm.debug("In __init__ in the polygon class.")
        self.features_lst = []
        logm.debug("The polygon object has been created. Exiting __init__ in the polygon class.\n")
    ...
    def setDefaults(self):
        logm.debug("In setDefaults in the polygon class.")
        logm.debug("setting default_feature to a feature() object.")
        self.default_feature = feature()
        self.default_feature.setDefaults()
